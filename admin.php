...
<table class="table">
  ...
  <tbody>
    <?php 
    $req = $pdo->query("SELECT * FROM reservation_user ORDER BY res_date_user DESC");
  ...
  ?>
    <tr>
      ...
      <td><a href="deleteReservation.php?id='<?php echo htmlspecialchars($donnees['id']);?>'"><i style="color:red;" class="fa-solid fa-trash-can"></i></a></td>
    </tr>
  <?php
