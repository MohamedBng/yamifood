...
<div class="d-flex flex-column flex-shrink-0 bg-light" style="width: 4.5rem;">
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
      ...
      <li>
        <a href="newsletterAdmin.php" class="nav-link active py-3 border-bottom" title="Orders" data-bs-toggle="tooltip" data-bs-placement="right">
...
<div id="sidebars">
  <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style=" height: 645px; width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="newsletterAdmin.php" class="nav-link active">
  ...
  <form method="post" onsubmit="return erreur();">
            ...
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting</p>
              ...
              <div class="col-md-12">
                ...
                <div class="submit-button text-center">
                  <input type="hidden" name="sendNewsletter" id="submithidden" value="sendNewsletter">
                  <button name="sendNewsletter" class="btn btn-common" id="submit" type="submit">Send Message</button>
                  <div id="insert" class="h3 text-center hidden"></div> 
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
      ...
      <script src="js/newsletterAdmin.js"></script>
  </body>
</html>